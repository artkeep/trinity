...
#define MSG_GOSSIP_BUY           "Buy GuildHouse (200000 gold)"
#define MSG_GOSSIP_SELL          "Sell GuildHouse (500 gold) - BROKEN"
...
#define COST_GH_BUY 2000000000 //200000 g.
...
bool showBuyList(Player *player, Creature *_creature, uint32 showFromId = 0)
{
 ...
 if(player->HasItemCount(20880, 1))
 {
