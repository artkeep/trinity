...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_RECRUIT_A_FRIEND_GROUP_REWARD_SPLIT] = ConfigMgr::GetBoolDefault("RecruitAFriend.RewardSplitInGroup", true);
    ...
    m_bool_configs[CONFIG_CHATLOG_WHISPER] = ConfigMgr::GetBoolDefault("CLogs.Ls", false);
    m_bool_configs[CONFIG_CHATLOG_SYSCHAN] = ConfigMgr::GetBoolDefault("ChatLogs.SysChan", false);
    m_bool_configs[CONFIG_CHATLOG_PARTY] = ConfigMgr::GetBoolDefault("CLogs.Pa", false);
    m_bool_configs[CONFIG_CHATLOG_RAID] = ConfigMgr::GetBoolDefault("ChatLogs.Raid", false);
    m_bool_configs[CONFIG_CHATLOG_GUILD] = ConfigMgr::GetBoolDefault("CLogs.Gi", false);
