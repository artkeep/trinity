...
Vehicle::Vehicle(Unit* unit, VehicleEntry const* vehInfo, uint32 creatureEntry) : _me(unit), _vehicleInfo(vehInfo), _usableSeatNum(0), _creatureEntry(creatureEntry)
{
    ...
    _me->ApplySpellImmune(0, IMMUNITY_ID, 19752, true);
    _me->ApplySpellImmune(0, IMMUNITY_ID, 53601, true);
    _me->ApplySpellImmune(0, IMMUNITY_ID, 53551, true);
    _me->ApplySpellImmune(0, IMMUNITY_ID, 17, true);
