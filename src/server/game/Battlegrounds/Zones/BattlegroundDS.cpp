...
{
    for (uint32 i = BG_DS_OBJECT_TYPE_DOOR_1; i <= BG_DS_OBJECT_TYPE_DOOR_2; ++i)
        SpawnBGObject(i, RESPAWN_IMMEDIATELY);
}
...
void BattlegroundDS::StartingEventOpenDoors()
{
    ...
    for (uint32 i = BG_DS_OBJECT_TYPE_BUFF_1; i <= BG_DS_OBJECT_TYPE_BUFF_2; ++i)
        SpawnBGObject(i, 60);
...
{
    // gates
    if (!AddObject(BG_DS_OBJECT_TYPE_DOOR_1, BG_DS_OBJECT_DOOR_1, 1350.95f, 817.2f, 20.8096f, 3.15f, 0, 0, 0.99627f, 0.0862864f, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_DS_OBJECT_TYPE_DOOR_2, BG_DS_OBJECT_DOOR_2, 1232.65f, 764.913f, 20.0729f, 6.3f, 0, 0, 0.0310211f, -0.999519f, RESPAWN_IMMEDIATELY)
    // water
        || !AddObject(BG_DS_OBJECT_TYPE_WATER_1, BG_DS_OBJECT_WATER_1, 1291.56f, 790.837f, 7.1f, 3.14238f, 0, 0, 0.694215f, -0.719768f, 120)
        || !AddObject(BG_DS_OBJECT_TYPE_WATER_2, BG_DS_OBJECT_WATER_2, 1291.56f, 790.837f, 7.1f, 3.14238f, 0, 0, 0.694215f, -0.719768f, 120)
    // buffs
        || !AddObject(BG_DS_OBJECT_TYPE_BUFF_1, BG_DS_OBJECT_BUFF_1, 1291.7f, 813.424f, 7.11472f, 4.64562f, 0, 0, 0.730314f, -0.683111f, 120)
        || !AddObject(BG_DS_OBJECT_TYPE_BUFF_2, BG_DS_OBJECT_BUFF_2, 1291.7f, 768.911f, 7.11472f, 1.55194f, 0, 0, 0.700409f, 0.713742f, 120))
    {
