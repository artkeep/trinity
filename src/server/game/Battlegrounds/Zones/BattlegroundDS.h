...
{
    BG_DS_OBJECT_TYPE_DOOR_1         = 0,
    BG_DS_OBJECT_TYPE_DOOR_2         = 1,
    BG_DS_OBJECT_TYPE_WATER_1        = 2,
    BG_DS_OBJECT_TYPE_WATER_2        = 3,
    BG_DS_OBJECT_TYPE_BUFF_1         = 4,
    BG_DS_OBJECT_TYPE_BUFF_2         = 5,
    BG_DS_OBJECT_MAX            = 6
};

enum BattlegroundDSObjects
{
    BG_DS_OBJECT_DOOR_1    = 192642,
    BG_DS_OBJECT_DOOR_2    = 192643,
    BG_DS_OBJECT_WATER_1   = 194395,
    BG_DS_OBJECT_WATER_2   = 191877,
    BG_DS_OBJECT_BUFF_1    = 184663,
    BG_DS_OBJECT_BUFF_2    = 184664
};
