...
enum ChannelDBCFlags
{
    ...
    CHANNEL_DBC_FLAG_ZONE_NAME  = 0x00002,              // General, Trade, LocalDefense, GuildRecruitment
    CHANNEL_DBC_FLAG_GLOBAL     = 0x00004,              // WorldDefense
    CHANNEL_DBC_FLAG_CHAT_CITYS = 0x00008,              // Trade, LFG
    CHANNEL_DBC_FLAG_CITY_ONLY  = 0x00010,              // Trade, GuildRecruitment, LFG
    CHANNEL_DBC_FLAG_CITY_NAME  = 0x00020,              // Trade, GuildRecruitment
